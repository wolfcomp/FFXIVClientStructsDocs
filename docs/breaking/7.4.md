Updated to commit `995e14fc2c4cf2060aa138aef60f639f374832dc`
...
- E
  - `EventFramework`
    `ProcessEventPlay` changed params from `GameObject* gameObject, EventId eventId, ushort scene, ulong flags, int* data, byte dataCount` to `GameObject* gameObject, EventId eventId, short scene, ulong sceneFlags, uint* sceneData, byte sceneDataCount`
  - `EventHandler`
    - Removed `UnkString1`
  - `EventHandlerModule`
